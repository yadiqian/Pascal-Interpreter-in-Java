...
```
## Test Files
The tests folder contains 24 pascal test files. The first 12 are from project 1 to test features implemented in project 1. The last 12 tests are newly added to test functionalities implemented in this project. 
